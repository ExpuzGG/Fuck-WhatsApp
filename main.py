...
def banner():
    ...
    os.system("clear")
    autoketik("""
\033[1;96m╔╦╗\033[1;97m┌─┐┌─┐┬  ┌─┐   \033[1;92m╦ ╦\033[1;97m┌─┐ | \033[1;96mJangan Disalah gunakan 
 \033[1;96m║ \033[1;97m│ ││ ││  └─┐"""+Fore.RED+"""───\033[1;92m║║║\033[1;97m├─┤ | \033[1;96mAuthor Tidak Menanggung Apa Yang Kalian Lakukan
 \033[1;96m╩ \033[1;97m└─┘└─┘┴─┘└─┘   \033[1;92m╚╩╝\033[1;97m┴ ┴ | Powered \033[1;96mExpuz Company""")
    print(abu + '-' * os.get_terminal_size().columns, end=''*2)
    print (Fore.RED+""" • \033[1;97mCreator"""+Fore.RED+""" : \033[1;92mExpuz""")
    print (Fore.RED+""" • \033[1;97mGithubb"""+Fore.RED+""" : \033[1;92mgithub.com/Expuz""")
...
def inputan():
    ...
    if modepesawat == "1":
        main()
    if modepesawat == "2":
        os.system("xdg-open https://instagram.com/expuz_")
        tanya()
    if modepesawat == "3":
        time.sleep(3)
